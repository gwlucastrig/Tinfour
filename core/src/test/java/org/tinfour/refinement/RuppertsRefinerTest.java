...
public class RuppertsRefinerTest {
    ...
    void testNoRefinementNeeded() {
        ...
        RuppertsRefiner refiner = new RuppertsRefiner(tin, minAngle, maxRatio);
    ...
    void testSegmentEncroachmentByExistingVertex() {
        ...
        constraintVertices.add(vA);
        constraintVertices.add(vB);
        IConstraint constraint = tin.addConstraint(constraintVertices);
        assertNotNull(constraint, "Constraint should be added");
        assertTrue(constraint.getEdges().get(0).isConstrained(), "Edge should be marked constrained");
    ...
    void testSegmentEncroachmentByCircumcenter() {
        ...
        tin.add(s1A);
        tin.add(s1B);
        List<Vertex> constraintS1Verts = new ArrayList<>();
        constraintS1Verts.add(s1A);
        constraintS1Verts.add(s1B);
        IConstraint constraintS1 = tin.addConstraint(constraintS1Verts);
        ...
        tin.add(sA);
        tin.add(sB);
        List<Vertex> constraintSVerts = new ArrayList<>();
        constraintSVerts.add(sA);
        constraintSVerts.add(sB);
        tin.addConstraint(constraintSVerts);
    ...
    void testIntegrationWithConstraintsAndQuality() {
        ...
        List<Vertex> constraintPoor = new ArrayList<>();
        constraintPoor.add(pA); constraintPoor.add(pB);
        tin.addConstraint(constraintPoor); // Constraint on the base of the skinny triangle.
